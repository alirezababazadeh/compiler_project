...
PROCEDURES = {
    ...
    "Selection-stmt": Procedure("Selection-stmt",
                                [ProductionRule(['if'],
                                                ['if', '(', 'Expression', ')', '#save', 'Statement', '#jpf_save',
                                                 'else', 'Statement', '#jp']),
                                 ],
                                ['ID', ';', 'NUM', '(', '{', '}', 'break', 'if', 'else', 'while', 'return', 'for', '+',
                                 '-'],
    ...
    "Iteration-stmt": Procedure("Iteration-stmt",
                                [ProductionRule(['while'],
                                                ['while', '#label', '(', 'Expression', ')', '#save', 'Statement',
                                                 '#while']),
                                 ],
                                ['ID', ';', 'NUM', '(', '{', '}', 'break', 'if', 'else', 'while', 'return', 'for', '+',
                                 '-'],
    ...
    "Simple-expression-prime": Procedure("Simple-expression-prime",
                                         ...
                                         True),
    "C": Procedure("C",
                   [ProductionRule(['<', '=='], ['#ptype', 'Relop', 'Additive-expression', '#relop']),
                    ],
                   [';', ']', ')', ','],
                   True, True),
    ...
    "Additive-expression-zegond": Procedure("Additive-expression-zegond",
                                            ...
                                            False),
    "D": Procedure("D",
                   [ProductionRule(['+', '-'], ['#ptype', 'Addop', 'Term', '#addop', 'D']),
                    ],
                   [';', ']', ')', ',', '<', '=='],
                   True, True),
