...
PROCEDURES = {
    ...
    "Declaration-initial": Procedure("Declaration-initial",
                                     [ProductionRule(['int', 'void'], ['#ptype', 'Type-specifier', '#declare', 'ID'])
                                      ],
                                     [';', '[', '(', ')', ','],
                                     False, False),
    ...
    "Params": Procedure("Params",
                        [ProductionRule(['int'],
                                        ['#ptype', 'int', '#declare', 'ID', 'Param-prime', '#declare_param',
                                         'Param-list']),
    ...
    "Iteration-stmt": Procedure("Iteration-stmt",
                                [ProductionRule(['while'],
                                                ['#loop_break', 'while', '#label', '(', 'Expression', ')', '#save',
                                                 'Statement',
                                                 '#while']),
                                 ],
                                ['ID', ';', 'NUM', '(', '{', '}', 'break', 'if', 'else', 'while', 'return', 'for', '+',
